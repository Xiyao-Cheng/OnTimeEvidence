...
$(document).ready(function () {
    ...
    $chatboxCredentials.on('submit', function (e) {
        ...
        $.ajax({
            type: "POST",
            url: "http://localhost:8050/user-profile-services/checkForUser",
            ...
            success: function (data, status, jqXHR) {
            	...
            	if(undefined ==  data['userQuadrant'] || data['userQuadrant'] == ''){
            		...
            		<a href= "http://localhost:9222/KBCommons-Web/getSurvayBio?id='+data['id'] +'"  style="color:red"> Click Here to take survey </a> ');
            	}else{
            		...
            		if(data['userQuadrant'] == '4'){ //both expert
            			...
            			accessToken = "d381ac58f1f344f2a6c52cb00f2e8068";
            		}
            		else{ //novice
            			accessToken = "5480ad7a5591468c8b600b92c9ed6e6d";
            		}
