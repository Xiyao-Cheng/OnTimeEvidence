...
@RestController
public class TMDataProcessController {
    ...
    public String dataCollection(@RequestBody String req) throws Exception {
		...
		String operation = String.valueOf(jsonInputConfigs.get("operation"));
        ...
        executeStatus.put("cmd", "python " + path + " --domain "+domainName + " --operation "+operation);
